package com.tasks.presentation.components
...
import com.a3b.commonui.components.OutlinedInputText
import com.a3b.commonui.components.TextCheckBox
import com.a3b.presentation.R
import com.tasks.domain.model.TasksInfo
import com.tasks.domain.util.Constants
import com.tasks.presentation.util.getColorFromPriority
                    ...
                    radioOptions.forEach { text ->
                        Row(
                            ...
                            CircleDot(
                                color = when (text) {
                                    stringResource(R.string.priority_low) -> {
                                        Constants.Tasks.LOW_PRIORITY.getColorFromPriority()
                                    }

                                    stringResource(R.string.priority_medium) -> {
                                        Constants.Tasks.MEDIUM_PRIORITY.getColorFromPriority()
                                    }

                                    else -> {
                                        Constants.Tasks.HIGH_PRIORITY.getColorFromPriority()
                                    }
                                }
                            )
